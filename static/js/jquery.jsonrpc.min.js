...
return url;},_requestDataObj:function(method,params,id){var dataObj={method:this.namespace?this.namespace+'.'+method:method,id:id}
...
if(typeof(success)==='function'){success(response);}},_response:function(json){if(json===undefined){return{error:'Internal server error',};}
else{try{if(typeof(json)==='string'){json=eval('('+json+')');}
return json;}
catch(e){return{error:'Internal server error: '+e,}}}}}});})(jQuery);